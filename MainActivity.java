...
public class MainActivity extends AppCompatActivity {
    TextView tv1;TextView tv2;TextView tv3;TextView tv4;TextView tv5;TextView tv6;TextView tv7;TextView tv8;TextView tv9;TextView tv10;TextView tv11;TextView tv12;TextView tv13;TextView tv14;TextView tv15;TextView tv16;TextView tv17;TextView tv18;TextView tv19;TextView tv20;TextView tv21;TextView tv22;TextView tv23;TextView tv24;TextView tv25;TextView tv26;TextView tv27;TextView tv28;TextView tv29;TextView tv30;
    Button q;Button w;Button e;Button r;Button t;Button y;Button u;Button i;Button o;Button p;Button a;Button s;Button d;Button f;Button g;Button h;Button j;Button k;Button l;Button z;Button x;Button c;Button v;Button b;Button n;Button m;
    String[][] enterWords = new String[6][5];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1 = findViewById(R.id.textView);tv2 = findViewById(R.id.textView2);tv3 = findViewById(R.id.textView3);tv4 = findViewById(R.id.textView4);tv5 = findViewById(R.id.textView5);tv6 = findViewById(R.id.textView6);tv7 = findViewById(R.id.textView7);tv8 = findViewById(R.id.textView8);tv9 = findViewById(R.id.textView9);tv10 = findViewById(R.id.textView10);tv11 = findViewById(R.id.textView11);tv12 = findViewById(R.id.textView12);tv13 = findViewById(R.id.textView13);tv14 = findViewById(R.id.textView14);tv15 = findViewById(R.id.textView15);tv16 = findViewById(R.id.textView16);tv17 = findViewById(R.id.textView17);tv18 = findViewById(R.id.textView18);tv19 = findViewById(R.id.textView19);tv20 = findViewById(R.id.textView20);tv21 = findViewById(R.id.textView21);tv22 = findViewById(R.id.textView22);tv23 = findViewById(R.id.textView23);tv24 = findViewById(R.id.textView24);tv25 = findViewById(R.id.textView25);tv26 = findViewById(R.id.textView26);tv27 = findViewById(R.id.textView27);tv28 = findViewById(R.id.textView28);tv29 = findViewById(R.id.textView29);tv30 = findViewById(R.id.textView30);
        newWords.animate().alpha(0);
    }

    /*public void greyButtons() {
        Button[] greyButton = {q, w, e, r, t, y, u, i, o, p, a, s, d, f, g, h, j, k, l, z, x, c, v, b, n, m};
        for(int i = 0; i <= 4; i++){
            if(!wordList[i].equals(" ")){
                for(int j = 0; j <= 25; j++){
                    if(((String) greyButton[j].getTag()).equals(wordList[i].toUpperCase(Locale.ROOT))){
                        q.setBackgroundTintList(ColorStateList.valueOf(Color.rgb(245,245,245)));
                    }
                }
            }
        }
    ...
    public void recreateWordList(){
        for (int i = 0; i <= 4; i++) {
            wordList[i] = bring.substring(i, i + 1).toUpperCase(Locale.ROOT);
        }
    }
    public void delete(View view) {
        if (column > 0) {
            enterWords[row][column - 1] = " ";
            changeLetters(-1);
            column --;
        }
    }
    public void lose(){
        Toast toast;
        if(row == 5 && column == 5 && correct != 5){
            toast = Toast.makeText(getApplicationContext(), "You Lose! Try again.", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.TOP, -300, 0);
            toast.show();
            toast = Toast.makeText(getApplicationContext(), "The word was " + bring, Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.TOP, -300, 0);
            toast.show();
            newWords.animate().alpha(1);
        }
    }
    public void enter(View view) {
        ...
        String tempWord = "";
        if (column != 5) {
            toast = Toast.makeText(getApplicationContext(), "Put in all five letters before trying to check", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.TOP, -300, 0);
            toast.show();
            return;
        }
        for(int i = 0; i <= 4; i ++){
            tempWord += enterWords[row][i];
        }

        tempWord = tempWord.toLowerCase();
        System.out.println(tempWord + "");
        for(int i = 0; i < list.length; i++){
            if (tempWord.equals(list[i])) {
                tempBool = true;
                break;
            }
        }
        if(!tempBool){
            ...
            toast = Toast.makeText(getApplicationContext(), "That's not a real word! Try again.", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.TOP, -300, 0);
            toast.show();
            column = 0;
            return;
        ...
        //turn everything red
        for (int i = 0; i <= 4; i++) {
            changeLettersColor(i, 2);
        }
        //turn green
        for (int i = 0; i <= 4; i++) {
            if (enterWords[row][i].equals(wordList[i])) {
                wordList[i] = " ";
                temp = i;
                changeLettersColor(i, 1);
                correct += 1;
            }
        }
        //turn yellow
        for (int i = 0; i <= 4; i++) {
            for (int j = 0; j <= 4; j++) {
                ...
                if (enterWords[row][i].equals(wordList[j])) {
                    wordList[j] = " ";
                    changeLettersColor(i, 5);
                    break;
                }
            }
        }
        ...
        if (correct == 5) {
            stop = 1;
            toast = Toast.makeText(getApplicationContext(), "You win! Go away now.", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.TOP, -300, 0);
            toast.show();
            newWords.animate().alpha(1);
        }
    ...
    public void buttons(View view){
        if(column != 5) {
            enterWords[row][column] = (String) view.getTag();
            changeLetters(0);
        }
    }

    public void changeLetters(int idk) {
        if (stop == 1) {
            return;
        }
        TextView[][] textViews = {
                ...
                {tv26, tv27, tv28, tv29, tv30}
        };
        textViews[row][column + idk].setText(enterWords[row][column + idk]);
        if (idk != -1) {
            if (column != 5) {
                column += 1;
            }
    ...
    public void changeLettersColor(int column, int color) {
        TextView[][] textViews = {
                {tv1, tv2, tv3, tv4, tv5},
                {tv6, tv7, tv8, tv9, tv10},
                {tv11, tv12, tv13, tv14, tv15},
        ...
        if (color == 0){
            textViews[row][column].setTextColor(Color.BLACK);
        }
        else if (color == 1) {
            textViews[row][column].setTextColor(Color.GREEN);
        }
        else if(color == 2){
            textViews[row][column].setTextColor(Color.RED);
        }
        else{
            textViews[row][column].setTextColor(Color.YELLOW);
        }
    }
}


//COMMENTED - grey buttons
//FIXED - loop < list.length()
//FIXED - skipping rows when not correct word
//TO DO - show correct word if failed
